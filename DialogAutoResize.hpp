...
#define ClioMK3DIALOG_LOG(severity) BOOST_LOG_TRIVIAL(severity) << "[ClioMK3DialogPlugin] "

class DialogAutoResize : public QDialog {
    Q_OBJECT

   public:
    DialogAutoResize(Arbiter &arbiter, bool fullscreen, QWidget *parent = nullptr);
